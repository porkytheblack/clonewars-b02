...
function MobileDropDown() {
  ...
  return (
    <CustomButton onClick={()=>{set_hover(!hover)}} onMouseEnter={()=>{set_hover(true)}} onMouseLeave={()=>{set_hover(false)}} className="flex flex-row items-center justify-between p-[20px_16px] border-none outline-none bg-transparent cursor-pointer"  >
        ...
        {hover && <MenuContainer vis={hover} className="flex flex-col items-center justify-start" >
            ...
            <Button disableRipple={true} className="cursor-pointer" >
